  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-contact">
            <h3>FARMING ASSISTANT WEB SERVICES</h3>
            <p>
              Mangalore<br>
              Karnataka, India <br><br>
              <strong>Phone:</strong> +91-9113651488<br>
              <strong>Email:</strong> info@krishimitra.com<br>
            </p>
          </div>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left">
        <div class="copyright">
          &copy; Copyright <strong><span>FARMING ASSISTANT WEB SERVICES</span></strong>. All Rights Reserved
        </div>
        <div class="credits">

...
<?php
							 $sql = "SELECT *,purchase_request.quantity as purreqqty,purchase_request.status as purreqstatus FROM `purchase_request` INNER JOIN product ON product.product_id=purchase_request.product_id  WHERE product.seller_id='$_SESSION[sellerid]'";
						    ...
						    <tr>
						      <td>&nbsp;$rs1[title]</td>
						      <td>&nbsp;$rs[purreqqty] $rs1[quantity_type]</td>

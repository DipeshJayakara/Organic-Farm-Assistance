...
<head>
  ...
  <title>FARMING ASSISTANT WEB SERVICES</title>
  <meta content="" name="FARMING ASSISTANT WEB SERVICES Web Portal helps farmers by providing all kinds agriculture related information in the website.">
  <meta content="Agriculture Management System, FARMING ASSISTANT WEB SERVICES" name="keywords">
    ...
    <div class="container">
      <div class="header-container d-flex align-items-center">
        <div class="logo mr-auto">
          <h1 class="text-light"><a href="index.php"><span>FARMING ASSISTANT WEB SERVICES</span></a></h1>

...
$sql = $sql . " ,'$_POST[category]','$_POST[produce]','$_POST[variety]','$_POST[title]','$imgname1','$imgname2','$imgname3','$imgname4','$imgname5','$_POST[quantity]','$_POST[quantitytype]','" .  mysqli_real_escape_string($con,$_POST['description']) . "','$dt','$_POST[status]')";	
